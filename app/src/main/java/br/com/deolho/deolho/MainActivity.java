...
public class MainActivity extends AppCompatActivity
    ...
    public static String IP_SERVIDOR = "10.0.0.102:8080";
//    public static String IP_SERVIDOR = "henriquesschmitt.ddns.net:8080";
            ...
            public void run() {
                try {
                    Thread t1 = new Thread(new Runnable() {
                        @Override
                        public void run() {
                            getDadosParlamentares("http://"+IP_SERVIDOR+"/DespesasParlamentaresWS/resources/parlamentar/all");
                        }
                    });
                    t1.start();
                    t1.join();
                        ...
                        public void run() {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    Long[] idDespesa = new Long[despesaList.size()];
                                    ...
                                    for (int i=0;i<despesaList.size();i++){
                                        ...
                                        valorDespesa [i] = "Valor: " + String.valueOf(usdCostFormat.format(despesaList.get(i).getValor()));
                                        idDespesa[i] = despesaList.get(i).getIdDespesa();
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (statusCode == 200) {
                                ...
                                List<Parlamentar> listaTemp = retornaListaDadosParlamentares(stringBuilder1.toString());
    ...
    public List<Parlamentar> retornaListaDadosParlamentares(String jsonLido){
        ...
        try {
            ...
            for (int i = 0; i < jsonarray.length(); i++) {
                ...
                String nome =  jsonobject.getString("nome").toUpperCase();
                ...
                String gastoDia = jsonobject.getString("gastoDia");
...
//    }
    ...
    public void onBackPressed() {
        ...
        builder.setMessage("Deseja sair do aplicativo DE OLHO?")
                .setCancelable(false)
                .setPositiveButton("Sim, voltarei outra hora!", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        MainActivity.this.finish();
                    }
                })
                .setNegativeButton("Não, quero ficar por aqui!", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        dialog.cancel();
                    }
                });
